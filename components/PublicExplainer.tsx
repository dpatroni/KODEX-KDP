export function PublicExplainer({ lang = "es" }: { lang?: "es" | "en" }) {
  ...
  const blocks = es
    ? [
        {
          title: "1. El problema",
          body: "El diseño convencional de máquinas eléctricas suele concentrarse en geometría, materiales y componentes principales. KODEX investiga una capa adicional de arquitectura bajo un marco propietario.",
        },
        {
          title: "2. La hipótesis",
          body: "Si las variables de arquitectura se exploran con un marco computacional confidencial, es posible comparar familias conceptuales que no son evidentes por intuición o prueba manual.",
        },
        {
          title: "3. Lo construido",
          body: "Hemos desarrollado un demostrador computacional que organiza arquitecturas candidatas, compara indicadores relativos y crea un ranking preliminar de configuraciones prometedoras.",
        },
        {
          title: "4. Evidencia preliminar",
          body: "La primera corrida del Architecture Explorer evaluó 5,760 arquitecturas conceptuales. Esto no prueba un resultado físico final, pero justifica una ruta conservadora de validación.",
        },
        {
    ...
    : [
        {
          title: "1. The problem",
          body: "Conventional electric-machine design usually focuses on geometry, materials and major components. KODEX investigates an additional architecture layer through a proprietary research framework.",
        },
        {
          title: "2. The hypothesis",
          body: "If architecture variables are explored through a confidential computational framework, it becomes possible to compare conceptual families that are not obvious through intuition or manual trial and error.",
        },
        {
          title: "3. What we built",
          body: "We developed a computational demonstrator that organizes candidate architectures, compares relative indicators and creates a preliminary ranking of promising configurations.",
        },
        {
          title: "4. Preliminary evidence",
          body: "The first Architecture Explorer run evaluated 5,760 conceptual architectures. This does not prove final physical performance, but it justifies a conservative validation path.",
        },
        {
          title: "5. Next stage",
